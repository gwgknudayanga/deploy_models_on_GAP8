...
def dump_image_with_labels(event_cube,ann_array,target_spatial_size,output_path,index,create_histo_frames = True):
    ...
    img_full_name = save_images_for_matchscore_calculation(output_path,file_id = index,img_array = dvs_frame,isImgFrame = False,target_size=(target_spatial_size,target_spatial_size))
