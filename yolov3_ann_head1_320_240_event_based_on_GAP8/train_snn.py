...
from obd1.models import ann_new_model_simple,yolo_base
...
if __name__ == '__main__': 
    ...
    parser.add_argument('-load', type=str, default='/work3/kniud/object_detection/SNN/spikingjelly/yolov3/yolov3_ann_best_model_2_head1/Trained_sigmoid_tiny_yolov3_snn/epoch_390_0.25526904008107615.pt', help='pretrained model')
    ...
    parser.add_argument('-path',        type=str,   default='/dtu/eumcaerotrain/data/latest_dataset/', help='dataset path')
    parser.add_argument('-output_dir',  type=str,   default='/work3/kniud/object_detection/SNN/spikingjelly/yolov3/yolov3_ann_best_model_2_head1', help='directory in which to put log folders')
    ...
    parser.add_argument("-train_csv_file",type=str,default="night_outdoor_and_daytime_train_files_event_based.txt",help="csv file...")
    parser.add_argument("-test_csv_file",type=str,default="test_files_event_based.txt",help="csv file...")
    parser.add_argument("-conf_thres",type=float,default="0.02")
    ...
    net = ann_new_model_simple.Network(in_channels=2,threshold=args.threshold,
    ...
    net.init_model((240,320),2)     #2 * args.tbins)
